...
class LinkedList[T]:
    ...
    def front(self) -> T:
        ''' returns the data item at front of the list without removing it
        Returns:
    ...
    def appendLeft(self, item: T) -> None:
        ...
        if self._size > 0 and not isinstance(item, type(self._head.data)):
            raise TypeError(f"cannot append {type(item).__name__} to list of {type(self._head.data).__name__}")
